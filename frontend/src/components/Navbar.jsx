...
import { ShoppingBag, Heart, User, Search, Sparkles, Shield, Package, MapPin, Flame, Award, Truck, Tag } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <Link to="/" className="flex items-center gap-2 group shrink-0">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-bold tracking-widest text-slate-400 uppercase">AI Commerce</span>
            </div>
          </Link>
          ...
          <form onSubmit={handleSearchSubmit} className="flex-1 max-w-md hidden md:block">
            <div className="relative">
              <input
                ...
                className="w-full bg-slate-100 border border-slate-200 rounded-full py-2 pl-10 pr-4 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:bg-white transition"
              />
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-200 text-xs font-extrabold flex items-center gap-1.5 hover:bg-indigo-100 transition shadow-sm"
      ...
      <div className="bg-slate-900 text-slate-200 text-xs py-2 px-4 shadow-inner">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <Link to="/shop?category=fashion" className="hidden lg:inline hover:text-white transition">
              Fashion & Apparel
            </Link>
